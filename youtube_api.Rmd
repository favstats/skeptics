...
```{r}
load("data/gg_amazingatheist.Rdata")
load("data/gg_armored.Rdata")
load("data/gg_logicked.Rdata")
load("data/gg_logicked.Rdata")
load("data/gg_thunder.Rdata")
...
ggsave(r_vs_sjw_all1, file = "images/r_vs_sjw_all1.png", width = 10, height = 14)
