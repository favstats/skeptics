...
comments_dat %<>% 
  ...
  sjw_keywords <- paste("blm", "black lives matter", "feminis", "race", "racis", "sexis", "postmodern", "marx", "antifa", "pc", "political correctness", sep = "|")
...
gg_thunder <- plot_data(thunder_comments, thunder_details)
...
#  geom_step() +
  ...
  theme_gdocs() +
  scale_color_fivethirtyeight(name = "Term") +
  ggtitle("Mentions of 'Religion' and 'SJW' in thunderf00t's Comments") +
  xlab("Date when Video was published") +
  ylab("Percentage of Comments per Video")

ggsave(r_vs_sjw_thunder, file = "r_vs_sjw_thunder.png", width = 7, height = 5)
...
ggsave(r_vs_sjw_sargon, file = "r_vs_sjw_sargon.png", width = 7, height = 5)
...
gg_all <- rbind(plot_data(armored_comments, armored_details),
                ...
                plot_data(thunder_comments, thunder_details))
