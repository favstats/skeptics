...
comments_dat %<>% 
  ...
  sjw_keywords <- paste("blm", "black lives matter", "feminis", "race", "racis", "sexis", "postmodern", "marx", "antifa", "pc", "political correctness", "regressive", "safe space", "social justice", "warrior", "snowflake", "identity politics", "classical liberal", "white knight", "white guilt", "mra", sep = "|")
...
#  summarise(n_sjw = sum(sjw))
  ...
  religion_keywords <- paste("god", "creation", "heaven", "hell", "relig", "theis", "paradise", "salvation", "religtard", "creed", "cult", "scripture", "devout", "divin", "pious", "theol", "pray", "sacred", "saint", "angel", "devil", "demon", "holy", sep = "|")
...
#  geom_step() +
  ...
  theme_gdocs() +
  scale_color_fivethirtyeight(name = "Topic") +
  ggtitle("Mentions of 'Religion' and 'SJW' in Mr Repzions's Comments") +
  xlab("Date when Video was published") +
  ylab("Percentage of Comments per Video")

ggsave(r_vs_sjw_repzion, file = "images/r_vs_sjw_repzion.png", width = 7, height = 5)
...
```{r}
gg_dates <- function(dataframe, name, events = F, width = 14, height = 10, facet = "none", ncol = 2, scales = "fixed", textsize = 18, linecolor = NA, filter_from = "2000-01-01") {
...
gg_thunder %>% 
  gg_dates(name = "ts_thunder", events = T)
